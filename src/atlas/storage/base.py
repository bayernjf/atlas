...
from atlas.monitoring.notify import AlertChannel, AlertChannelDelivery
...
class MonitoringRepository(Protocol):
    ...
    def record_alert_channel_delivery(
        self, delivery: AlertChannelDelivery
    ) -> None: ...
    # M9：灰度门控越阈显式 critical 告警（docs/52 起 PG 档同形）
